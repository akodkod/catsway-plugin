...
bool USimpleInteractionCharacterComponent::IsActorVisibleToCharacter(AActor* Actor) const {
  APawn* OwningPawn = GetOwner<APawn>();
...
bool USimpleInteractionCharacterComponent::IsActorVisibleToCamera(AActor* Actor) const {
  APawn* OwningPawn = GetOwner<APawn>();
  if (!OwningPawn) return false;
...
bool USimpleInteractionCharacterComponent::IsActorTraceable(AActor* Actor, FVector Start, AActor* IgnoreActor) const {
...
void USimpleInteractionCharacterComponent::UnmarkActorsAsNearbyThatAreNotFromList(const TArray<AActor*>& Actors) {
...
void USimpleInteractionCharacterComponent::UnfocusActor(const AActor* Actor) {
